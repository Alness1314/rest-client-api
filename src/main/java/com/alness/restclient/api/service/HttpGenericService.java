...
public interface HttpGenericService {
  ...
  public <T, B> T put(String path, Map<String, ?> query, B body, @Nullable String jwt, Class<T> responseType);
  public <T> T delete(String path, Map<String, ?> query, @Nullable String jwt, Class<T> responseType);
